...
- [ ] 8. Web: low-poly feature meshes — rock clusters, boxy buildings (connected where adjacent), cone trees.
...
- [ ] 31. Content: mode wiring — `MatchSetup.mode`, map objectives → engine config, king designation.
...
- [ ] 34. AI: capture-the-flag — fetch flag, carry home, return dropped flag, hunt carrier.
